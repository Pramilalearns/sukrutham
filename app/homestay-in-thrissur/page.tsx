...
export default function RoomsPage() {
    ...
    const rooms = [
        {
            ...
            description: "Our most spacious room (180 sq.ft.), designed with a blend of traditional Kerala aesthetics and modern luxury, making it the best homestay in Thrissur. Features a private sit-out verandah with panoramic views of the lush paddy fields.",
            priceTwin: "₹6,500",
            priceSingle: "₹3,500",
            amenities: [
        ...
        },
        {
            ...
            description: "A tastefully appointed 120 sq.ft. room, offering uninterrupted views of the greenery surrounding the property. Perfect for comfort and connection at our stay in Thrissur.",
            priceTwin: "₹5,500",
            priceSingle: "₹3,000",
            amenities: [
                { icon: Droplets, label: "Running Hot Water" },
    ...
    return (
        <main className="min-h-screen bg-stone-50 overflow-x-hidden max-w-[100vw]">
                        ...
                        <div className="lg:w-5/12">
                            <div className="sticky top-32">
                                ...
                                <p className="text-stone-600 text-lg font-light leading-relaxed mb-8">
                                    We thoughtfully design a holistic farmhouse experience in Kerala, where every booking at our stay in Thrissur envelopes you in these premium inclusions, ensuring a seamless and authentic retreat into nature.
                                </p>
                                {/* Decorative line */}
            ...
            {/* "Why You Will Love Your Stay - A premier homestay in Thrissur Kerala" - Comprehensive section */}
                ...
                <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <ScrollAnimation delay={200} className="lg:col-span-1 bg-[#FAF8F5] p-8 md:p-10 rounded-[2rem] shadow-sm border border-[#F0EBE1] flex flex-col justify-center">
                            ...
                            <p className="text-stone-600 text-base leading-relaxed">
                                This beautiful homestay in Thrissur Kerala offers opportunities to slow down and immerse yourself in local life. Guests can take peaceful village walks, try fishing with locals, or visit nearby cultural landmarks such as Kerala Kalamandalam, renowned for classical dance and music traditions.
                            </p>
                        </ScrollAnimation>
                        ...
                        <ScrollAnimation delay={300} className="lg:col-span-2 relative bg-[#EAECE4] p-8 md:p-10 rounded-[2rem] shadow-sm border border-[#DCE2D4] flex flex-col justify-center">
                            ...
                            <div className="relative z-10 w-full mb-10 pt-4 md:pt-0 pl-0 sm:pl-20 md:pl-24 lg:pl-32">
                                ...
                                <p className="text-stone-700 text-base leading-relaxed mb-4">
                                    If you need to work while travelling, this home stay in Thrissur provides the best of both worlds. As a top homestay in Thrissur Kerala, reliable high-speed internet ensures productivity, while the natural surroundings offer refreshing breaks.
                                </p>
                                <p className="text-stone-700 text-base leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                        ...
                        <ScrollAnimation delay={400} className="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-stone-100 flex flex-col sm:flex-row items-start gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-stone-600 text-base leading-relaxed">
                                    Sukrutham, an eco-friendly homestay in Thrissur, is designed with care for the environment. Solar panels, rainwater harvesting, and eco-friendly design elements help preserve the beauty of the land while supporting sustainable living.
                                </p>
                            </div>
                        </ScrollAnimation>
                        ...
                        <ScrollAnimation delay={500} className="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-stone-100 flex flex-col sm:flex-row items-start gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-stone-600 text-base leading-relaxed">
                                    From arranging farm tours and local experiences to assisting with transportation, our Thrissur homestay team ensures every guest feels welcomed and cared for throughout their stay.
                                </p>
                            </div>
                        </ScrollAnimation>
                    </div>
